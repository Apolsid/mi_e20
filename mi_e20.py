...
test_file = 'test/1.mp3'
test_file_new = 'test/1_new.mp3'

'''
TAG   128

0x0			0x8		- метка (всегда одна и таже)
0x8			0x4		- ==размер 1
0x10		0x4		- метка (всегда одна и таже)
0x14		0x4		- id пакета
0x18		0x4		- какая-то константа
0x1C		0x4		- размер пакета с музыкой (байт) от 0x410
0x24		0x4		- возможно версия (везде 1)
0x28		0x8		- нули ???

размер 1 - размер 2 = 1028 байт
'''
